...
from models.CamoEval_enhanced_ablation_receptive124 import EnhancedDegreeNet as Network
from models.enhanced_components_ablation_receptive124 import StreamlinedLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./log/MyTrain_Enhanced_ablation_receptive124/',
    ...
    if opt.disable_enhanced:
        ...
        model = Network(channel=256)  # Enhanced features by default
        criterion = StreamlinedLoss(
