...
def train(train_loader, model, optimizer, epoch, save_path, writer, criterion):
    ...
    loss_components = {
        'main_loss': 0, 'perceptual_loss': 0, 'contrast_loss': 0, 
    ...
    try:
        for i, (images, mask, gts, seg_label) in enumerate(train_loader, start=1):
            ...
            if i % 100 == 0 or i == total_step or i == 1:
                ...
                print(f'  Main: {loss_dict["main_loss"]:.4f}, Perceptual: {loss_dict["perceptual_loss"]:.4f}')
                print(f'  Contrast: {loss_dict["contrast_loss"]:.4f}, Semantic: {loss_dict["semantic_loss"]:.4f}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alpha_perceptual', type=float, default=0.1, help='perceptual loss weight')
    parser.add_argument('--alpha_contrast', type=float, default=0.05, help='contrast loss weight')
    parser.add_argument('--alpha_domain', type=float, default=0.1, help='domain loss weight')
    parser.add_argument('--alpha_semantic', type=float, default=0.1, help='semantic loss weight')
    ...
    if opt.disable_enhanced:
        ...
        criterion = StreamlinedLoss(
            ...
            alpha_contrast=opt.alpha_contrast,
