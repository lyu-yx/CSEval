...
from models.Dual_Encoder_CamoEval import UEDGNet as Network
...
from models.dataset import get_loader, test_dataset, get_test_loader
...
def classification_loss(pred, gt):
    ...
    """
    loss = F.cross_entropy(pred, gt - 1)
    return loss
...
def train(train_loader, model, optimizer, epoch, save_path, writer):
    ...
    try:
        for i, (images, mask, gts) in enumerate(train_loader, start=1):
            optimizer.zero_grad()
            ...
            with torch.cuda.amp.autocast():
                ...
                loss = classification_loss(preds, gts)
...
def val(test_loader, model, epoch, save_path, writer):
    ...
    with torch.no_grad():
        ...
        for i, (image, mask, gt, name) in enumerate(test_loader):
            ...
            try:
                ACC.step(pred=pred_labels, gt=gt - 1)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--batchsize', type=int, default=12, help='training batch size')  # 16
