...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./log/MyTrain_Enhanced_ablation_loss_perceptual1_domain1/',
    ...
    parser.add_argument('--alpha_domain', type=float, default=1, help='domain loss weight')  # ori:0.1
