...
from models.CamoEval_enhanced_dofixre6 import EnhancedDegreeNet as Network
from models.enhanced_components_dofixre6 import StreamlinedLoss
    ...
    try:
        for i, (images, mask, gts, seg_label) in enumerate(train_loader, start=1):
            ...
            if i % 100 == 0 or i == total_step or i == 1:
                ...
                print(
                    f'  Main: {loss_dict["main_loss"]:.4f},  Domain: {loss_dict["domain_loss"]:.4f}')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./log/MyTrain_Enhanced_dofixre6/',
