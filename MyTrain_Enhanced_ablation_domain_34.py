...
from models.CamoEval_enhanced_ablation_domain_34 import EnhancedDegreeNet as Network
from models.enhanced_components_ablation_domain_34 import StreamlinedLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./log/MyTrain_Enhanced_ablation_domain_34/',
