...
from models.CamoEval_enhanced_baseline0 import EnhancedDegreeNet as Network
from models.enhanced_components_baseline0 import StreamlinedLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./log/MyTrain_Enhanced_baseline0/',
