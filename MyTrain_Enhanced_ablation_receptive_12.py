...
from models.CamoEval_enhanced_ablation_receptive12 import EnhancedDegreeNet as Network
from models.enhanced_components_ablation_receptive12 import StreamlinedLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./log/MyTrain_Enhanced_ablation_receptive12/',
