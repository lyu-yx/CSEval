...
from models.enhanced_components_onlyprototype import UnsupervisedSemanticDiscovery
...
class EnhancedDecoder(nn.Module):
    ...
    def __init__(self, channels):
        ...
        self.simplified_conv = nn.Sequential(
    ...
    def forward(self, E4, E3, E2, E1, mask):
        ...
        # no adaptive receptive fields
        E5 = torch.cat((E4, E3, E2), 1)
        E5 = self.simplified_conv(E5)

        # Apply semantic discovery to the enhanced features
        semantic_features, part_attention = self.semantic_discovery(E5)
