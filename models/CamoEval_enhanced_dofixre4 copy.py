...
from models.enhanced_decoder_dofixre4 import EnhancedDecoder
from models.enhanced_components_dofixre4 import DomainAdapter
...
class EnhancedDegreeNet(nn.Module):
    ...
    def forward_enhanced(self, x, mask, training_mode=True):
        ...
        fb4_adapted, fb3_adapted, fb2_adapted, domain_logits = self.domain_adapter(fb4.detach(), fb3.detach(), fb2.detach(), training_mode)

        # Pass original and adapted features to the decoder for efficient fusion and processing
