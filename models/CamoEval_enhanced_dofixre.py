...
from models.enhanced_decoder_dofixre import EnhancedDecoder
from models.enhanced_components_dofixre import DomainAdapter
...
class EnhancedDegreeNet(nn.Module):
    ...
    def forward_enhanced(self, x, mask, training_mode=True):
        ...
        fb4_adapted, fb3_adapted, fb2_adapted, domain_logits = self.domain_adapter(fb4, fb3, fb2, training_mode)

        fb4_adapted = fb4 + fb4_adapted
        fb3_adapted = fb3 + fb3_adapted
        fb2_adapted = fb2 + fb2_adapted

        # Process through enhanced decoder
        pred, target_pred, fixation = self.decoder(
            fb4_adapted, fb3_adapted, fb2_adapted, fb1, mask
        )
