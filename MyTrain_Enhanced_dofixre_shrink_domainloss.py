...
from models.CamoEval_enhanced_dofixre4 import EnhancedDegreeNet as Network
from models.enhanced_components_dofixre4 import StreamlinedLoss
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_path', type=str, default='./log/MyTrain_Enhanced_dofixre4_shrink_domainloss/',
    ...
    parser.add_argument('--alpha_domain', type=float, default=5, help='domain loss weight')  # ori:0.1
